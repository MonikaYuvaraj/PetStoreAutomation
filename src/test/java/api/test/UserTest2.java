...
import api.endpoints.UserEndPoinds2ByPropertyFile;
...
//		userpayload.setJob("monika");
	...
	public void testPostUser() {
		...
		Response response = UserEndPoinds2ByPropertyFile.createUser(userpayload);
	...
	public void testGetUser() {
		...
		Response response = UserEndPoinds2ByPropertyFile.readUser(2);
		response.then().log().all();
...
//		Assert.assertEquals(response.jsonPath().get("name"), "Monika");
	...
	public void testUpdateUser() {
		...
		Response response = UserEndPoinds2ByPropertyFile.updateUser(2, userpayload);
	...
	public void testDeleteUser() {
		...
		Response response = UserEndPoinds2ByPropertyFile.deleteUser(2);
		// Static ID as reqres doesn't persist
		response.then().log().all();
